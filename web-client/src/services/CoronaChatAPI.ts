...
export class CoronaChatAPI {
  ...
  private static readonly getTemplateURL =
    "https://app.coronainfochat.org/getTemplate";
  private static readonly updateTemplateURL =
    "https://app.coronainfochat.org/updateTemplate";
  private static readonly getDefaultTemplateURL =
    "https://app.coronainfochat.org/getDefaultTemplate";
